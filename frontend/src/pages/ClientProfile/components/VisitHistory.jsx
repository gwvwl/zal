    ...
    <div className={styles.vhList}>
      {pageVisits?.map((visit) => {
        ...
        return (
          <div
            key={visit.id}
            className={`${styles.vhItem} ${isNow ? styles.vhItemNow : ""}`}
          >
            <div className={styles.vhDot} />
            <div className={styles.vhContent}>
              <div className={styles.vhRow}>
                <span className={styles.vhDate}>
                  {formatDateTime(visit.entered_at)}
                </span>
                {isNow && (
                  <span className={styles.vhNowBadge}>Зараз у залі</span>
                )}
              </div>
              {visit.exited_at && (
                <div className={styles.vhMeta}>
                  ...
                  {duration && (
                    <span className={styles.vhDuration}>· {duration}</span>
                  )}
                </div>
              )}
            </div>
