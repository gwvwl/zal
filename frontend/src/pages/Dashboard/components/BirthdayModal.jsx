    ...
    <div className={styles.smOverlay} onClick={onClose}>
      <div className={styles.smModal} onClick={(e) => e.stopPropagation()}>
        <div className={styles.smHeader}>
          ...
          <button className={styles.smCloseBtn} onClick={onClose}>
            ✕
          </button>
        </div>
              ...
              >
                ...
                <div className={styles.smInfo}>
                  ...
                  <span className={styles.smMeta}>
                    {formatBirthday(client.birth_date)} · виповнюється{" "}
                    {calcAge(client.birth_date)} р.
                  </span>
                </div>
                <span
                  className={
                    client.days === 0 ? styles.bmTagToday : styles.bmTagSoon
                  }
                >
                  {client.days === 0
                    ? "🎉 Сьогодні!"
